...
\begin{compactenum}
	...
	\item a node where the vehicle has picked up a task in a City A and delivered no task in the City A;
	\item a node where the vehicle has picked up no task and delivered a non-zero amount of tasks to a City A.\\
\end{compactenum}
